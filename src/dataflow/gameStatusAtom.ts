...
import {
  PlayersAtomValue,
  playersInitializeExecutor,
  playersSelector,
  playersUpdateExecutor,
} from "./playersAtom";
...
export const gameStatusUpdateExecutor = atom(
  null,
  (get, set, next: GameStatus) => {
...
// ゲームの開始
export const gameStartExecutor = atom(
  null,
  (get, set, players: PlayersAtomValue) => {
