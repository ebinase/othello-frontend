...
const ResetButton: React.FC<Props> = (props) => {
  return (
    <>
      {/* https://heroicons.com/ */}
      <button
        className="hover:shadow-[4px_4px_3px_#bebebe,-4px_-4px_3px_#ffffff] m-4 px-5 py-1 text-slate-400 rounded-lg shadow-[2px_2px_1px_#bebebe,-2px_-2px_1px_#ffffff]"
