...
const SettingsInfo: React.FC = (props) => {
  ...
  return (
    <div className=" h-full text-center flex flex-col items-center sm:justify-center pb-6 sm:pt-6 pt-10">
      ...
      <div className="mt-8 flex gap-5 justify-center w-full">
          <button
            className="shadow-[5px_5px_5px_#bebebe,-5px_-5px_5px_#ffffff] text-slate-700 text-sm font-bold hover:text-slate-400 rounded-lg px-5 py-2 border-2 border-slate-200 w-2/5 flex gap-2 justify-center"
            onClick={handlePvP}
        >
